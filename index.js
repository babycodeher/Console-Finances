...
for (let i = 1; i < finances.length; i++) {
    ...
    if (profitLoss > biggestProfitIncrease){
        biggestProfitIncrease = profitLoss; 
        profitDate = dates;
    }
    
    if (profitLoss < 0 && profitLoss < biggestProfitDecrease) {
        biggestProfitDecrease = profitLoss;
        lossDate = dates;
    }
 }
